...
#define ST7735_RES_Pin       GPIO_PIN_0 // ST7735 RESET pin (active low)
#define ST7735_RES_GPIO_Port GPIOB
#define ST7735_CS_Pin        GPIO_PIN_4	// ST7735 chip selct pin (active low)
#define ST7735_CS_GPIO_Port  GPIOA
#define ST7735_DC_Pin        GPIO_PIN_6	// ST7735 DC/A0 pin (low for command and high for data)
