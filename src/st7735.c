...
void ST7735_DrawHLine(uint16_t X1, uint16_t X2, uint16_t Y, uint16_t color) {
  uint16_t i;
  uint8_t data[] = { color >> 8, color & 0xFF };
...
void ST7735_DarawVLine(uint16_t X, uint16_t Y1, uint16_t Y2, uint16_t color) {
  uint16_t i;
  uint8_t data[] = { color >> 8, color & 0xFF };
...
void ST7735_DrawLine(int16_t X1, int16_t Y1, int16_t X2, int16_t Y2, uint16_t color) {
	...
	if (dX == 0) {
		if (Y2>Y1) ST7735_DarawVLine(X1,Y1,Y2,color); else ST7735_DarawVLine(X1,Y2,Y1,color);
		return;
	}
	if (dY == 0) {
		if (X2>X1) ST7735_DrawHLine(X1,X2,Y1,color); else ST7735_DrawHLine(X2,X1,Y1,color);
		return;
	}
...
void ST7735_DrawRectangle(uint16_t X1, uint16_t Y1, uint16_t X2, uint16_t Y2, uint16_t color) {
	ST7735_DrawHLine(X1,X2,Y1,color);
	ST7735_DrawHLine(X1,X2,Y2,color);
	ST7735_DarawVLine(X1,Y1,Y2,color);
	ST7735_DarawVLine(X2,Y1,Y2,color);
}
